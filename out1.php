...
{		
	...
	{
		odbc_exec($hris, "UPDATE [misInv].[dbo].[Itemmaster] set inoutflag = 'O' where itemcode='".$ic."'");
		header ('location:allowout.php');
	}
	if (isset($_POST['btn2'])) //no
	{
		header ('location:OutNotSameAsOwner.php');
	} 
?>
...
<form action='' method='post'>
		...
		<font style='font-family:Courier New;font-size:20px;color:black;margin-left:147px;'>&nbsp;&nbsp;
			...
			<br>
			<font style='font-family:Courier New;font-size:20px;color:black;margin-left:33px;'><b>DURATION &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></font><input type="text" readonly name="txt11" placeholder="N/A"  value="<?php echo $sdrtn1 ?>"   style="width:200px; text-align:center;color:black;border-color:skyblue;border-radius:5px;height:20px;margin-top:5px;font-family:Courier New; font-size:18px;"><input type="text" readonly name="txt11" placeholder="N/A"  value="<?php echo $edrtn1 ?>"   style="width:200px; text-align:center;color:black;border-color:skyblue;border-radius:5px;height:20px;margin-top:5px;font-family:Courier New;font-size:18px;">
          </div>
		  
		       <div style='border-style: double;margin-top:-20px;width:1354px;margin-left:-5px'></div>
