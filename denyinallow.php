...
{
 if (isset($_POST['btn1'])) //yes sa expired
 {
    ...
    while ($row = odbc_fetch_array($resfn))
	{
		...
		$reason = 'Item duration has expired.';
		$flag = 'EXP';
		$prob = '1';

		odbc_exec($hris, "UPDATE [misInv].[dbo].[ItemMaster] SET  InOutFlag = 'I' where ItemCode = '".$ic."'");
		odbc_exec($hris, "UPDATE [sample].[dbo].[HistoryLog]  SET empnum='".$emp."', associatename='".$usm."', empnumberfull='".$qqqq."', department='".$qqq."', allowcode='".$allc."', problemflag ='".$prob."', reviewcode='".$flag."', reviews='".$reason."' where LogID = '".$lgid."'");

		header ('location:allowin.php');
	}
 }
 if (isset($_POST['btn2'])) //no sa expired
 {
 	$fn = "SELECT EmpNumber, Username FROM [misInv].[dbo].[ItemMaster]  where ItemCode = '".$ic."'";
	$resfn = odbc_exec($hris, $fn);
...
<div style="margin-top:18px;margin-left:2px;">
&nbsp;&nbsp;&nbsp;<label class="blink"><span><!-- (  ǃ ) Your due date is expired! Please proceed to I.T Department --></span></label><br>
...
<form action='' method='post'>
				...
				<font style='font-family:Courier New;color:black;margin-left:10px;font-size:18px;'><b> MODEL &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </b></font>
		...
		<font style='font-family:Courier New;font-size:20px;color:black;margin-left:147px;'>&nbsp;&nbsp;
			...
			<font style='font-family:Courier New;font-size:20px;color:black;margin-left:33px;'><b>DURATION &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b><input type="text" readonly name="txt11" placeholder="N/A"  value="<?php echo $sdrtn1 ?>"   style="width:200px; text-align:center;color:black;border-color:skyblue;border-radius:5px;height:20px;margin-top:5px;font-family:Courier New; font-size:18px;"><input type="text" readonly name="txt11" placeholder="N/A"  value="<?php echo $edrtn1 ?>"   style="width:200px; text-align:center;color:black;border-color:skyblue;border-radius:5px;height:20px;margin-top:5px;font-family:Courier New;font-size:18px;">		   
		       ...
		       <div style='border-style: double;width:1354px;margin-left:-5px;margin-top:-20px'></div>
					...
					<div style='border-style: solid; border-color: red; width: 750px; height: 100px; margin-top: 15px'>
					<font style='font-family:Californian FB;font-size:80px;margin-left:33px;color:red'><b> SAME AS OWNER?</b></font>
					</div>
		  
		  <div style='border-style: ; border-color: ; width: 319px; height: 140px; margin-top: -120px;margin-left:999px'>
...
echo "<script> alert ('( ✘ ) The Item Duration has Expired ! ') </script>";		//Please Coordinate to I.T Department.
}
?>
</html>
