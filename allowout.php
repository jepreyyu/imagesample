...
<form action='' method='post'>
		...
		<font style='font-family:Courier New;font-size:20px;color:black;margin-left:147px;'>&nbsp;&nbsp;
	      ...
	      <div style='border-style: ; border-color:; width: 1350px; height:20px;'>
	   <input type="submit" name="allow" value="Back" style="background-color: blue; font-size: 32px; font-family: Courier new; color: white;  width:188px;height:49px;text-align:center;margin-left:1090px;border-radius:5px; font-weight: bold;"> 
	   <input type="submit" name="deny" value="" style="background-image:url('img/new/Picture13.png'); visibility: hidden; width:188px;height:49px;text-align:right;margin-left:-1250px;border-radius:10px"> 
</div>
     </form>
</body>
</html>
